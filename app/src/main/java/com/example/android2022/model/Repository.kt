...
object Repository {
    ...
    val cars = arrayListOf(
        MainItem.Car(
            ...
            info = "The Nissan Silvia S13 was launched in 1990 with a CA18 engine, which was later replaced with an iconic SR20 turbocharged engine with 200hp. The engine belts out 350 horses after tuning up, which was introduced to the S14 and S15 models.\n" +
                    "\n" +
        ...
        MainItem.Car(
            ...
            info = "The Nissan Skyline GT-R tops the list with good reason. Equipped with the most advanced technology of its time, its unrivalled speed and maneuverability have made it a regular winner on the racing circuit. And its starring role in “The Fast and the Furious” movies made it a winner with turbofans.\n" +
        ...
        MainItem.Car(
            ...
            info = "IS THAT A SUPRA??? AAAAAAAAUUU \n" +
